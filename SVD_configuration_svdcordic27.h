...
#define LIMITE_INFERIOR_PRECISION_SVD pow(2.0,-63)
#define LIMITE_INFERIOR_PRECISION_TRIG pow(2.0,-63)
#define LIMITE_INFERIOR_PRECISION_SINCOS pow(2.0,-63)
//#############################################
#define	PRECISION float //double or float